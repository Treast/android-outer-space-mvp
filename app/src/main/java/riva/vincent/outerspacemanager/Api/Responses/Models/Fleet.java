...
public class Fleet {
    ...
    public Fleet(Integer gasCost, Integer life, Integer maxAttack, Integer minAttack, Integer mineralCost, String name, Integer shipId, Integer shield, Integer spatioportLevelNeeded, Integer speed, Integer timeToBuild) {
